...
public class DashboardServlet extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
        ...
        List<Consulta> consultasRecentes = consultaService.listar();
        ...
        req.setAttribute("totalConsultas", consultaService.contar());
        req.setAttribute("consultasRecentes", consultasRecentes);
